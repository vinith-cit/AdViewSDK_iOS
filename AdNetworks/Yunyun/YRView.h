...
//  YunYun SDK
//
//  Created by YunYun on 2013-03-22.
//  Copyright 2013年 YunYun. All rights reserved.
//
...
+ (void) setRootTargetViewController:(UIViewController *)rootViewController;
 ...
 * 返回值：广告视图对象。                                               *
 *******************************************************************/
+ (YRView *)requestYRViewWithYRDelegate:(id<YRViewDelegate>) delegate withFormat:(YRViewFormat)yrViewFormat;

/*******************************************************************
 * 初始化SDK,返回广告视图对象                                           *
 * sizeofAd：显示广告区域的CGSize大小。                                 *
 * delegate：YRViewDelegate对象，广告视图将执行YRViewDelegate中定义的方法。*
 * scale   ：广告栏的缩放参数，[1.0,0.0)。                              *
 * 返回值：广告视图对象。                                               *
 *******************************************************************/
